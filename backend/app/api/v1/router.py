...
from app.api.v1.endpoints.interview_ws import router as interview_ws_router
...
api_router.include_router(interview_ws_router, prefix="/interview", tags=["interview-ws"])
